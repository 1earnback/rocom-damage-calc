...
export const NATURES: Record<string, { boost_stat: string | null; reduce_stat: string | null }> = {
  ...
  懒散: { boost_stat: 'def', reduce_stat: 'spdef' },
  ...
  认真: { boost_stat: 'spatk', reduce_stat: 'hp' },
  实干: { boost_stat: 'spdef', reduce_stat: 'hp' },
  坦率: { boost_stat: 'atk', reduce_stat: 'hp' },
  害羞: { boost_stat: 'def', reduce_stat: 'hp' },
  浮躁: { boost_stat: 'speed', reduce_stat: 'hp' },
  沉默: { boost_stat: 'hp', reduce_stat: 'atk' },
  平和: { boost_stat: 'hp', reduce_stat: 'spatk' },
  理智: { boost_stat: 'hp', reduce_stat: 'def' },
  犹豫: { boost_stat: 'hp', reduce_stat: 'spdef' },
  紧张: { boost_stat: 'hp', reduce_stat: 'speed' },
};
